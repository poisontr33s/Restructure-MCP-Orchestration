...
interface PackageInfo { name?: string; version?: string; private?: boolean; scripts?: Record<string,string>; dir: string }
interface WorkflowInfo { name: string; file: string }
