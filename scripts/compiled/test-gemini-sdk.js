...
async function main() {
  ...
  const inputText =
    process.argv[2] ||
    'Hello! Please identify yourself as Gemini 2.5 Pro and confirm you have access to Google Search tools. Then search for "TypeScript SDK Google GenAI" and summarize what you find.';
  const contents = [
    {
      role: 'user',
      parts: [
